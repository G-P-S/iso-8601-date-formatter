...
- (NSString *) weekDateStringForDate:(NSDate *)date timeZone:(NSTimeZone *)timeZone {
	...
	NSDateComponents *ordinalComponents = [unparsingCalendar components:NSCalendarUnitYear fromDate:[unparsingCalendar dateFromComponents:startOfYearComponents] toDate:date options:0];
